...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed top-0 w-full z-50 text-zinc-50 transition-all duration-300 ${scrolled ? 'bg-zinc-950/90 backdrop-blur-md border-b border-white/10' : 'bg-transparent'}`}>
